#converting pythagorean code to a function for module based code, keeps it all clean and lean
...
hypot1 = calculateHypotenuse(firstTriangleSide1, firstTriangleSide2) # call function to do
calc
secondTriangeSide1 = raw_input('Enter the first side: ')
secondTriangeSide2 = raw_input('Enter second side: ')
hypot2 = calculateHypotenuse(secondTriangeSide1, secondTriangeSide2) # call function to do
calc
